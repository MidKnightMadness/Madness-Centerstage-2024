...
public class AprilTagLocalizerUsingError extends Localizer { // Currently runs on main thread, may be an issue, uses ConceptAprilTag as basis
    // AUXILLARY VARIABLES =========================================================================
    ...
    public AprilTagLocalizerUsingError(HardwareMap hardwareMap, Telemetry telemetry, double relX, double relY, double cameraAngle) {
